...
interface PlayerFormProps { player?: Player, onUpdatePlayerList: () => void, closeEdit?: () => void }

export const PlayersForm = ({ player, onUpdatePlayerList, closeEdit }: PlayerFormProps) => {
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={6}>
          <TextField
            ...
            onChange={formik.handleChange}
            error={formik.touched.jerseyNumber && Boolean(formik.errors.jerseyNumber)}
            helperText={formik.touched.jerseyNumber && formik.errors.jerseyNumber}
          />
        </Grid>
        <Grid item xs={12} sm={6}>
          <TextField
